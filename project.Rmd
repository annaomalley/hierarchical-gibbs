...
# results - need to understand n_eff
monitor(sims)
```
...
mcmc.gibbs <- function(chain) {
  ...
  #tmp <- c(theta.f, s.param[[1,7]], s.param[[1,8]], s.param[[1,9]])
  #print(tmp)
  #sims[1,1,] <- tmp
  ...
  for (s in 2:sims) {
    ...
    #print(c(s.param[[s,1]], s.param[[s,2]], s.param[[s,3]], s.param[[s,4]], s.param[[s,5]], s.param[[s,6]], s.param[[s,7]], s.param[[s,8]], s.param[[s,9]]))
    #sims[s,1,] <- c(s.param[[s,1]], s.param[[s,2]], s.param[[s,3]], s.param[[s,4]], s.param[[s,5]], s.param[[s,6]], s.param[[s,7]], s.param[[s,8]], s.param[[s,9]])
  }
